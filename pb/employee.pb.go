...
const (
	Occupation_OCCUPATION_UNKNOWN Occupation = 0 // デフォルト値
...
type Employee struct {
	...
	Occupation  Occupation                  `protobuf:"varint,4,opt,name=occupation,proto3,enum=employee.Occupation" json:"occupation,omitempty"`                                                         // 列挙型
	PhoneNumber []string                    `protobuf:"bytes,5,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`                                                              // 繰り返しフィールド
	Project     map[string]*Company_Project `protobuf:"bytes,6,rep,name=project,proto3" json:"project,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // マップフィールド
	// Types that are assignable to Profile:
	//
	//	*Employee_Text
	//	*Employee_Video
	Profile  isEmployee_Profile `protobuf_oneof:"profile"`
	Birthday *Date              `protobuf:"bytes,9,opt,name=birthday,proto3" json:"birthday,omitempty"` // インポートしたメッセージを使用
}
